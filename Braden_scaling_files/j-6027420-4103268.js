//Generated:2022-11-04 20:41:43// 39-536
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_6027420 || '',
    GUID: window.ftGUID_6027420 || '99999999999',
    confID: window.ftConfID_6027420 || '0',
    ftReturn: window.ftReturn_6027420 || '',
    keyword: window.ftKeyword_6027420 || '',
    ftId: window.ftId_6027420 || '',
    imp: window.ftImp6027420,
    ftImpId: window.ftImp6027420 && window.ftImp6027420.impID || '',
    gdpr: window.ftImp6027420 && window.ftImp6027420.gdpr || '',
    gdpr_consent: window.ftImp6027420 && window.ftImp6027420.gdpr_consent || '',
    gdpr_pd: window.ftImp6027420 && window.ftImp6027420.gdpr_pd || '',
    us_privacy: window.ftImp6027420 && window.ftImp6027420.us_privacy || '',
    campaignID: '166920',
    cID: '157924',
    pID: '6027420',
    creativeID: '4103268',
    ...
    clickTags: [
      "http://servedby.flashtalking.com/click/8/166920;6027420;4103268;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://business.comcast.com/business-choice?CMP=BAC-[%ebuy!]-[%esid!]-[%epid!]-[%ecid!]&omndfa=1&dclid=[%FT_RANDOM%]-[%eadv!]-[%ebuy!]-[%epid!]-[%eaid!]-[%erid!]&DIV=Central-166920-6027420-4103268"
    ],
    placementDescription: 'BUSQ12022B2BCENTOTDT6027420FT728x90',
    width: 728,
    height: 90,
    ...
    divID: 'ftdiv6027420',
    phID: 'ftpos6027420',
    frameID: 'ftframe6027420',
    expID: 'ftexpframe6027420',
    altImgID: 'ftalt6027420',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'http://servedby.flashtalking.com/click/8/166920;6027420;4103268;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://business.comcast.com/business-choice?CMP=BAC-[%ebuy!]-[%esid!]-[%epid!]-[%ecid!]&omndfa=1&dclid=[%FT_RANDOM%]-[%eadv!]-[%ebuy!]-[%epid!]-[%eaid!]-[%erid!]&DIV=Central-166920-6027420-4103268',
    altImg: 'http://servedby.flashtalking.com/imp/8/166920;6027420;204;gif;XfinityUS;BUSQ12022B2BCENTOTDT6027420FT728x90/?',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/166920;6027420;271;pixel;XfinityUS;BUSQ12022B2BCENTOTDT6027420FT728x90/?',
    stump: 'http://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/602/6027420/4103268/js/j-6027420-4103268.js',
    file: 'http://cdn.flashtalking.com/157924/4103268/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?224867400-6027420;4103268;',
    adVis: false ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_6027420 || '',
    segmentList: window.ftSegmentList_6027420 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp6027420 && window.ftImp6027420.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m6027420') && /^https:/.test(document.getElementById('ftscript_m6027420').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m6027420'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_6027420'],
      ['ftcfid', 'ftConfID_6027420'],
      ['fttime', 'ftTimestamp_6027420'],
      ['ftsection', 'ftSection_6027420'],
      ['ftcustom', 'ftCustom_6027420'],
      ['ft_id', 'ftId_6027420'],
      ['ftimpid', 'ftImp6027420', 'impID'],
      ['gdpr', 'ftImp6027420', 'gdpr'],
      ['gdpr_consent', 'ftImp6027420', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp6027420', 'gdpr_pd'],
      ['us_privacy', 'ftImp6027420', 'us_privacy']
    ]
  };
...
ft6027420.addEventListener("start",function(){
  //var usrSegs= "u0r,u0u,uyt,123".split(','),
  var usrSegs = (window.ftSegment_6027420 !== "") ? window.ftSegment_6027420.split(","): [],
   matched = [],
   getCCSegs = getCCSegs();
